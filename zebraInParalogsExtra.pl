...
open(OUT,">zebraInParalogs2.txt") ||die("zebraInParalogs2.txt does not open");
...
open(IN,"unCheckedZebraInParalogs.txt") ||die("unCheckedZebraInParalogs.txt does not open");
